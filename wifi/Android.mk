...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.biloba.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.biloba.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.biloba
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.biloba.rc \
    android.hardware.wifi@1.0-service.biloba.xml
